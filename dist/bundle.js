...
"use strict";
eval("\n\n__webpack_require__(/*! ./style/style.scss */ \"./src/style/style.scss\");\n\nvar _game = _interopRequireWildcard(__webpack_require__(/*! ./components/game.js */ \"./src/components/game.js\"));\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }\n\nvar game = new _game.default();\nvar startBtn = document.getElementsByClassName('start-btn')[0];\nstartBtn.addEventListener('click', startGame);\nvar scoreBoth = _game.score.scoreBoth,\n    scorePLayer = _game.score.scorePLayer,\n    scoreComputer = _game.score.scoreComputer;\n\nfunction startGame() {\n  _game.score.update();\n\n  _game.score.add();\n\n  _game.info.remove();\n\n  game.play();\n}\n\n//# sourceURL=webpack:///./src/index.js?");
